  ...
  <div class="bg-white auction">
    ...
    <div class="banner flex items-center h-[35vh] lg:h-[55vh] relative">
      ...
      <div class="z-50 text-white w-full m-auto w-[80%]">
        ...
        <div class="flex py-8">
          ...
          <svg class="my-auto mx-[1%] ltr:rotate-180" width="18" height="13" viewBox="0 0 18 13" fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <path d="M0.999878 6.49976L16.9999 6.49976" stroke="white" stroke-width="1.5" stroke-linecap="round"
    ...
    <div class="filter px-[1%] py-[3%] m-auto max-w-[1290px]">
      <div class="grid lg:grid-cols-3 grid-cols-1 bg-white shadow-lg w-full gap-4 px-[3%] py-[2%]">
        <div class="py-2 relative sh">
          <div class="relative">
            <InputText v-model="filter.name" required class="bg-[#f7f5f5] w-full shadow"
              :placeholder="$t('إسم المجمع')" />
            <span
              class="pi pi-search absolute top-[50%] rtl:left-[5%] ltr:right-[5%] transform -translate-y-[50%] z-50"></span>
          </div>
        </div>
        <div class="py-1 relative my-auto">
          <div class="relative">
            <Dropdown style="height: 100% !important" filter v-model="filter.city_id_filter" option-value="id"
              :options="cityes" optionLabel="name" :placeholder="$t('select_city')"
              class="shadow w-full bg-[#f7f5f5] [&>div>div>span]:bg-black md:w-14rem my-[1%]" />
          </div>
        </div>
        <div class="flex items-center text-center">
          <Button @click="fetchdata" style="background-color: #65bdc4" :label="$t('search')"
    ...
    <div class="px-[1%] py-[3%] m-auto max-w-[1290px]">
      <div class="bg-white shadow-lg rounded-lg p-6 border border-[#e5e7eb]">
        <h3 class="text-2xl font-bold text-[#046A72] mb-4 border-b pb-2">{{ $t('advanced_search') }}</h3>

        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <!-- Area -->
          <div class="space-y-1">
            <label class="block text-sm font-medium text-[#303843]">{{ $t('owner_name') }}</label>
            <InputText v-model="Advanced.owner_name" class="w-full bg-[#f7f5f5] border-none rounded-md"
              :placeholder="$t('owner_name')" />
          </div>

          <div class="space-y-1">
            <label class="block text-sm font-medium text-[#303843]">{{ $t('area') }}</label>
            <InputText v-model="Advanced.area" class="w-full bg-[#f7f5f5] border-none rounded-md"
          ...
          <div class="space-y-1">
            ...
            <InputNumber v-model="Advanced.building_number" class="w-full bg-[#f7f5f5] border-none rounded-md"
          ...
          <div class="space-y-1">
            ...
            <InputNumber v-model="Advanced.residential_units_number" class="w-full bg-[#f7f5f5] border-none rounded-md"
              :placeholder="$t('enter_number')" />
          </div>
          ...
          <div class="space-y-1">
            ...
            <InputNumber v-model="Advanced.commercial_units_number" class="w-full bg-[#f7f5f5] border-none rounded-md"
              :placeholder="$t('enter_number')" />
          </div>
        </div>
        ...
        <div class="flex gap-3 justify-end mt-6 border-t pt-4">
          <Button @click="Advanced_Search"
            ...
            :label="$t('search')" />
          <Button @click="clear_Advanced_Search"
            class="px-6 py-2 bg-[#4FA8AF] text-white rounded-md hover:bg-[#4FA8AF] transition-colors"
    ...
    <div class="px-[1%] py-[3%] m-auto max-w-[1290px]">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-3 mt-3">
        <div v-for="rent in allauctions" style="transition: 0.7s"
          ...
          <div class="">
            <div class="">
              <div class="w-full h-44" :style="{ backgroundImage: `url(${rent?.image})` }"
                style="background-position: center; background-repeat: no-repeat; background-size: cover"></div>
            </div>
            <div class="flex justify-between p-2">
              <div>
                <div class="flex py-1">
                  <a :href="rent?.location_url" target="_blank" class="flex bg-[#E6F4F6] py-1 px-1 rounded-md"
                    ...
                    <div class="my-auto">
                      <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path
                          ...
                          stroke="#046A72" stroke-width="1.5" />
                      </svg>
                    </div>
                    <p class="text-[#046A72] text-sm px-1">{{ rent.area }} - {{ rent.city }}</p>
                  </a>
                  <a target="_blank" class="flex bg-[#65bdc4] mx-2 py-1 px-1 rounded-md"
          ...
          <div class="grid grid-cols-3 p-[1%] gap-2">
            <div class="border-2 p-[2%] rounded-sm">
              <h4 class="py-2">
                <svg width="27" height="26" class="mx-auto" viewBox="0 0 25 24" fill="none"
                  xmlns="http://www.w3.org/2000/svg">
                  <path
            ...
            <div class="border-2 p-[2%] rounded-sm">
              <h4 class="py-2">
                <svg width="27" class="mx-auto" height="27" viewBox="0 0 25 25" fill="none"
                  xmlns="http://www.w3.org/2000/svg">
                  <path
