   ...
   <div class=" detail lg:px-[5%] px-[2%] m-auto  max-w-[1399px] py-4">
    ...
    <div class="grid grid-cols-5 p-[1%] gap-1">
            <div class=" p-1 flex items-center  rounded-sm">
              ...
              <p class="text-sm font-bold text-center text-center" v-if="auction_details?.status == 'running'">ينتهي بعد :</p>
              <p class="text-sm font-bold text-center text-center" v-if="auction_details?.status == 'comming'">قادم بعد :</p>
            ...
            <div class="border-2 p-[2%] rounded-sm">
              <h4 class="text-xl font-medium text-[#46494A] text-center" v-if="auction_details?.status != 'finished'">{{ auction_details?.day }}</h4>
            ...
            <div class="border-2 p-[2%] rounded-sm">
              <h4 class="text-xl font-medium text-[#46494A] text-center" v-if="auction_details?.status == 'finished'">0</h4>
              <h4 class="text-xl font-medium text-[#46494A] text-center" v-if="auction_details?.status == 'comming' && auction_details?.start_time < currentHour ">{{   currentHour  - auction_details?.start_time}}</h4>
      ...
      <div class="lg:col-span-2 shadow-md p-4">
         <div class="flex justify-between ">
          ...
          <div class="flex">
            ...
            <svg  class="mx-4 hidden" width="57" height="43" viewBox="0 0 57 43" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M7.59632 7.08472H3.01414V9.95571H6.87382C9.40258 9.95571 10.4673 11.1155 10.4673 13.4161V18.1884H0.504395V21.0784H13.5475V13.245C13.5665 9.29025 11.7412 7.08472 7.59632 7.08472Z" fill="#01355A"/>
            <path d="M6.3411 3.58647C7.27275 3.58647 8.03328 2.80693 8.03328 1.89429C8.03328 0.962647 7.29176 0.183105 6.3411 0.183105C5.42847 0.183105 4.64893 0.962647 4.64893 1.89429C4.64893 2.80693 5.42847 3.58647 6.3411 3.58647Z" fill="#01355A"/>
            <path d="M33.4925 3.58647C34.4241 3.58647 35.1846 2.80693 35.1846 1.89429C35.1846 0.962647 34.4431 0.183105 33.4925 0.183105C32.5798 0.183105 31.8003 0.962647 31.8003 1.89429C31.8003 2.80693 32.5798 3.58647 33.4925 3.58647Z" fill="#01355A"/>
            <path d="M48.6267 0.183105C47.7141 0.183105 46.9346 0.962647 46.9346 1.89429C46.9346 2.80693 47.7141 3.58647 48.6267 3.58647C49.5584 3.58647 50.3189 2.80693 50.3189 1.89429C50.2999 0.962647 49.5584 0.183105 48.6267 0.183105Z" fill="#01355A"/>
            <path d="M36.4014 18.2077H29.8418V13.7016C29.8418 11.2109 30.9065 9.95599 33.4733 9.95599H36.4014V18.2077ZM47.0868 18.2077H39.5195V7.08499H32.8079C28.5869 7.08499 26.7427 9.42362 26.7427 13.4354V18.2077H22.0274C20.5253 18.2077 19.8409 17.5803 19.8409 15.9642V0.240234H16.7417V15.6029C16.7417 19.4246 18.0156 21.0787 22.1795 21.0787H50.1479V7.08499H47.0868V18.2077Z" fill="#01355A"/>
            <path d="M56.4034 0.240234H53.3042V21.0787H56.4034V0.240234Z" fill="#01355A"/>
            <path d="M11.3227 31.9163H5.99902V42.3545H8.39469V33.8746H10.9425C12.5776 33.8746 13.224 34.5401 13.224 36.1562V42.3355H15.6197V36.2132C15.6387 33.2472 14.3078 31.9163 11.3227 31.9163Z" fill="#01355A"/>
            <path d="M18.6805 31.2125V31.916H17.0454V33.8363H18.6805V42.3542H21.0762V33.8363H24.3275V31.916H21.0762V31.2695C21.0762 30.3569 21.3994 30.0336 22.3121 30.0336H24.3275V28.1323H21.7417C19.5742 28.1323 18.6805 29.0259 18.6805 31.2125Z" fill="#01355A"/>
            <path d="M32.4463 37.6773V40.4532H29.0999C28.1873 40.4532 27.712 39.9779 27.712 39.0652C27.712 38.1526 28.1873 37.6773 29.0999 37.6773H32.4463ZM30.7731 31.9163H25.8867V33.8366H30.7351C31.99 33.8366 32.4082 34.2739 32.4082 35.5288V35.7759H28.5486C26.4951 35.7759 25.2593 37.0118 25.2593 39.0652C25.2593 41.1187 26.4951 42.3545 28.5486 42.3545H34.8229V35.9661C34.8229 33.0951 33.6441 31.9163 30.7731 31.9163Z" fill="#01355A"/>
            <path d="M40.2798 29.2163H37.8842V31.9162H36.249V33.8365H37.8842V39.2743C37.8842 41.4608 38.7778 42.3544 40.9643 42.3544H43.8353V40.4341H41.5347C40.6221 40.4341 40.2988 40.1109 40.2988 39.1982V33.8365H43.8353V31.9162H40.2988V29.2163H40.2798Z" fill="#01355A"/>
            <path d="M52.0871 31.916H49.2731V28.1323H46.8774V42.3542H49.2731V33.8743H51.7068C53.3229 33.8743 53.9884 34.5398 53.9884 36.1559V42.3352H56.4031V36.2129C56.4031 33.2469 55.0721 31.916 52.0871 31.916Z" fill="#01355A"/>
            <path d="M2.91907 28.1323H0.504395V42.2782H2.91907V28.1323Z" fill="#01355A"/>
            <path d="M54.8823 24.5582V23.9117C54.8823 23.6075 54.9964 23.4934 55.3196 23.4934H55.9851V22.5618H55.1865C54.3499 22.5618 53.9126 23.0181 53.9126 23.8737V24.5582H53.3042V25.4898H56.4034V24.5582H54.8823Z" fill="#01355A"/>
            </svg>
         ...
         <div class="p-[2%] grid grid-cols-3 my-2  md:gap-2 gap-4">
          ...
          <div>
            <Button  style=" background-color: #AA1E22 !important;"  label=" سجل فى المزاد" class="mt-3 w-[90%]  focus:ring-0 text-[#AA1E22]"/>
          </div>
...
axios
  ...
  .then((res) => {
    ...
    auction_details.value.end_time= res.data.result.data.end_time ? res.data.result.data.end_time.split(":")[0] : null,
    auction_details.value.day= res.data.result.data.status == 'running'
                  ? Math.ceil((new Date(res.data.result.data.end_date) - new Date(formattedDate.value)) / (1000 * 60 * 60 * 24))
                  : Math.ceil((new Date(res.data.result.data.start_date) - new Date(formattedDate.value)) / (1000 * 60 * 60 * 24)),

                  auction_details.value.second=(res.data.result.data.start_time).split(":")[1],
                  auction_details.value.duration= res.data.result.data.status == 'running' && res.data.result.data.end_date && res.data.result.data.start_date
                  ? Math.ceil((new Date(res.data.result.data.end_date) - new Date(formattedDate.value)) / (1000 * 60 * 60 * 24))
                  : Math.ceil((new Date(res.data.result.data.start_date) - new Date(formattedDate.value)) / (1000 * 60 * 60 * 24)),
                  auction_details.value.duration= res.data.result.data.end_date && res.data.result.data.start_date ? Math.ceil((new Date(res.data.result.data.end_date) - new Date(res.data.result.data.start_date)) / (1000 * 60 * 60 * 24)): null
